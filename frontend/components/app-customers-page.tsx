...
const customers = [
  ...
  { id: 11, name: "Robert Green", membershipType: "Silver", status: "Inactive" },
  { id: 12, name: "Olivia Taylor", membershipType: "Bronze", status: "Active" },
  { id: 13, name: "Daniel Brown", membershipType: "Gold", status: "Active" },
  { id: 14, name: "Sophia Martinez", membershipType: "Silver", status: "Active" },
  { id: 15, name: "William Johnson", membershipType: "Bronze", status: "Inactive" },
  { id: 16, name: "Ava Thompson", membershipType: "Gold", status: "Active" },
  { id: 17, name: "James Wilson", membershipType: "Silver", status: "Active" },
  { id: 18, name: "Isabella Garcia", membershipType: "Bronze", status: "Active" },
  { id: 19, name: "Benjamin Moore", membershipType: "Gold", status: "Inactive" },
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
            ...
            <Card key={customer.id} className="bg-gray-800 border-gray-700">
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs text-gray-400">{customer.membershipType}</span>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        {filteredCustomers.length === 0 && (
          <p className="text-center text-gray-400 mt-8">No customers found matching your search.</p>
        )}
      </div>
    </div>
  )
